  ...
  <div class="legal">
    ...
    <article class="doc container">
      ...
      <template v-if="doc === 'agreement'">
        <p>欢迎使用「有余」记账（以下简称"本应用"）。在使用前，请你仔细阅读本《用户协议》。当你注册、登录或使用本应用，即表示你已阅读并同意本协议的全部内容。</p>
        <h2>一、服务内容</h2>
        <p>本应用为你提供个人记账服务，包括账户管理、收支与转账记录、分类管理、报表统计与数据导出等功能。记账、查看数据与导出数据为基础功能，永久免费，且不含任何第三方广告。</p>
        <h2>二、账号与安全</h2>
        <p>你需自行设置账号与密码并妥善保管。你应对在你账号下发生的所有操作负责。若发现账号被未经授权使用，请及时修改密码。</p>
        <h2>三、你的数据</h2>
      ...
      <template v-else>
        ...
        <h2>一、我们收集的信息</h2>
        <p>为提供记账服务，我们收集：你注册时提供的账号与经加盐哈希存储的密码；你主动录入的账户、交易与分类等账目数据。我们不收集与记账无关的个人敏感信息。</p>
        <h2>二、信息的使用</h2>
        <p>我们仅将上述信息用于向你提供记账、统计与导出等本应用功能，以及保障账号安全（如登录失败保护）。我们不会向第三方出售你的个人信息。</p>
        <h2>三、数据存储与安全</h2>
        <p>你的密码以加盐哈希形式存储，我们无法还原你的明文密码。你的账目数据按用户严格隔离，其他用户无法访问。我们采取合理的技术措施保护数据安全。</p>
        <h2>四、数据可携带与删除</h2>
