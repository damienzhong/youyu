...
public class GrowthController {
    ...
    /**
     * 成长概览（需令牌）：等级、经验、升级进度、累计统计与 16 枚徽章，字段集恰好 15 项（需求 10.1、10.13）。
     *
     * <p>achievement-system 需求 12.2 把徽章清单从 9 枚扩到 16 枚，<strong>顶层 15 项与徽章项 6 项的
     * 字段集一字不改</strong>，变的只有列表长度。</p>
     *
